...
{ 
   ...
   /* public function updateTroops( $_POST, $vid )
    ...
    {
        $this->provider->executeQuery( "UPDATE p_villages v SET v.troops_num='%s', v.crop_consumption=v.crop_consumption-%s WHERE  v.id=%s", array( $new_troops_num, $crop_consumption,  floatval( $vid ) ) );
    }
